...
export const writeBase64 = (filePath: string, base64Str: string) => {
...
export const handleImageFile = (fileDir: string, files: any) => {
  let imageList = [];
  try {
...
const writeFile = (file: Buffer, fileDir: string, filename: string) => {
  // 创建可读流
